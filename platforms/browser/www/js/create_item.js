    ...
    // Register three observers:
        ...
        uploadTask.on('state_changed', function(snapshot){
          ...
          uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL) {
            ...
            db.collection("users").doc(app.user.uid).collection("items").doc("items_array").update({"array": FieldValue.arrayUnion(obj)})
                .then(function() {
                    db.collection("pools").doc(app.selectedPoolId).collection("items").doc("items_array").update({array: FieldValue.arrayUnion(obj)})
                        .then(function() {
                ...
                .catch(function(error) {
                    console.error("Error writing document: ", error);
                    db.collection("users").set(app.user.uid).collection("items").doc("items_array").set({"array": [obj]})
                        .then(function() {
